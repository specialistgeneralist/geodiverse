...
% .. 1st only
G1  = rowfun(@(x,y) meanm(x,y), T1,...
	'InputVariables', {'lat' 'lon'},...
	'GroupingVariables', 'Journal',...
	'OutputVariableNames', {'journal_geomean_lat_1st' 'journal_geomean_lon_1st'});
% .. combined 1st and 2nd
G12  = rowfun(@(x,y) meanm(x,y), T12,...
	'InputVariables', {'lat' 'lon'},...
	'GroupingVariables', 'Journal',...
	'OutputVariableNames', {'journal_geomean_lat_1st2nd' 'journal_geomean_lon_1st2nd'});
% .. join together for all Journals
S = join(S, G1,...
	'Keys', 'Journal',...
	'RightVariables', {'journal_geomean_lat_1st' 'journal_geomean_lon_1st'});
S = join(S, G12,...
	'Keys', 'Journal',...
	'RightVariables', {'journal_geomean_lat_1st2nd' 'journal_geomean_lon_1st2nd'});
...
S.journal_stdist_linear_1st2nd_m = S.journal_stdist_linear_1st2nd_km * 1000;

% -- export; csv delim
S = S(:, {'Journal' 'n_1st_affiliations' 'n_2nd_affiliations' 'n_1st2nd_affiliations' ...
	'journal_geomean_lat_1st' 'journal_geomean_lon_1st' 'journal_geomean_lat_1st2nd' 'journal_geomean_lon_1st2nd' ...
	'journal_stdist_linear_1st_deg' 'journal_stdist_linear_1st2nd_deg' ...
